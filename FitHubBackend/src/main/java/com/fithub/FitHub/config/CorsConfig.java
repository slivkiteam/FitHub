...
public class CorsConfig {
    private static final String X_REQUESTED_WITH = "X-Requested-Wit";
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedHeaders(List.of(AUTHORIZATION, CONTENT_TYPE, ACCEPT, ACCESS_CONTROL_ALLOW_ORIGIN, ORIGIN));
