        ...
        <>
            ...
            <header className="header">
                <div className="header-desktop">
                    <a href="#">
                    <svg width="115.506104" height="97.597656" viewBox="0 0 115.506 97.5977" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <desc>
                        </desc>
                        <defs/>
                    ...
                    <nav>
                        <ul className="nav_list">
                            <li className="nav-item-1"><a href="#">личный кабинет</a></li>
                            <li className="nav-item-2"><a href="trainings.html">тренировки</a></li>
                    ...
                    <div className="training-cards-container">
                        <ul className="training-cards">
                            {Array.from({ length: 3 }).map((_, index) => (
                                <li className="training-card" key={index}>
                                    <figure>
                                        <img className="training-img" alt={`Тренировка №${index + 1}`} />
                                    </figure>
                                    <div className="training-type-box">
                                        <ul className="tag-list">
                                            <li className="cardio-red"><a href="#">тип тренировки</a></li>
                                        </ul>
                                    </div>
