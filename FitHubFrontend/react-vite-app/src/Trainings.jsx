                ...
                <main>
                    ...
                    <div className="filter-training-desktop">
                        ...
                        <div className="search-and-cards">
                            <p className="search">
                                <input type="text" className="search-input" placeholder="поиск"></input>
                            </p>
                            <Training title="tren"/>
                            <Training title="megatren"/>
                            <Training title="megatren"/>
                            <Training title="megatren"/>
                            <Training title="megatren"/>
                            <Training title="megatren"/>
            ...
            <footer className="fithub-footer">
                <div className="fithub-footer-content">
                    <a className="footer-svg" href="#">
                        <svg viewBox="0 0 115.506 97.5977" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <desc>
                            </desc>
                            <defs/>
                            <path id="Fit hub" d="M29.37 0L3.11 0L3.11 33.59L9.5 33.59L9.5 19.53L28.32 19.53L28.32 14.06L9.5 14.06L9.5 5.75L29.37 5.75L29.37 0ZM40.31 0L33.93 0L33.93 33.59L40.31 33.59L40.31 0ZM44.49 5.75L56.64 5.75L56.64 33.59L63.07 33.59L63.07 5.75L75.21 5.75L75.21 0L44.49 0L44.49 5.75Z" fill="#292929" fill-opacity="1.000000" fill-rule="evenodd"/>
